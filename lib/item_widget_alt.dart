...
//the original ItemWidget code
class ItemWidgetAlt extends StatefulWidget {
  final Map curItem;
  ...
  @override
  _ItemWidgetAltState createState() => _ItemWidgetAltState();
}

class _ItemWidgetAltState extends State<ItemWidgetAlt> {
