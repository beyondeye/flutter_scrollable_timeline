...
class HorizontalPickerAlt extends StatefulWidget {
  ...
  @override
  _HorizontalPickerAltState createState() => _HorizontalPickerAltState();
}

class _HorizontalPickerAltState extends State<HorizontalPickerAlt> {
